...
func game_won():
	get_tree().change_scene_to_packed(load("res://scenes/level_9.tscn"))
...
func populate_tanks():
	...
	%VTank2.init(left_lp, Globals.Colors.GREEN, Globals.Colors.RED)
	...
	%VTank3.init(right_lp, Globals.Colors.RED, Globals.Colors.GREEN)
